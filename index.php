...
?>
        ...
        <main>
            ...
            <section>
                ...
                <p>
                    Our <strong>goal</strong> is to give everyone a fair chance, no matter 
                    their age, gender, or nationality.
                </p>
                <p>
                    One Studio currently has three available roles:
                    <strong>Ethical Hacking</strong>, <strong>Security Analysis</strong>, 
                    and <strong>Threat Hunting</strong>.
                </p>
            </section>
            <section id="roles">
                ...
                <article class="threat-hunter">
                    ...
                    <ul>
                        ...
                        <li>Use threat intelligence and behaviour analysis to detect attacks.
                        </li>
                        <li>Work with the wider security team to improve defences over time.
                        </li>
                    </ul>
                </article>
            </section>
            ...
            <section id="start">
                ...
                application. If you want more information about each role, review the details
                on our Job Opportunities page.
                </p>
                <p>
