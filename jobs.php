        ...
        <main>
            <section>
                <article class="job-card">
                    ...
                    <div class="job-text">
                        <h2>Position Title: 
                        <?php echo isset($jobs["EHK01"]) ? esc($jobs["EHK01"]["title"]) : "Title not available"; ?>
                        </h2>
                        <p>
                        <?php echo isset($jobs["EHK01"]) ? esc($jobs["EHK01"]["description"]) : "Description not available."; ?>
                        </p>
            ...
            <section>
                <article class="job-card">
                    <div class="job-image">
                        <img src="images/security-analyst.jpg" alt="Security Analyst">
                    </div>
                    <div class="job-text">
                        <h2>Position Title: 
                        <?php echo isset($jobs["SEC02"]) ? esc($jobs["SEC02"]["title"]) : "Title not available"; ?>
                        </h2>           
                        <p>
                        <?php echo isset($jobs["SEC02"]) ? esc($jobs["SEC02"]["description"]) : "Description not available."; ?>
                        </p>
                        <h3>Key Responsibilities</h3>
                        <ul>
            ...
            <section>
                <article class="job-card">
                    ...
                    <div class="job-text">
                        <h2>Position Title: <?php echo isset($jobs["THH03"]) ? esc($jobs["THH03"]["title"]) : "Title not available"; ?>
                        </h2>
                        <p>
                        <?php echo isset($jobs["THH03"]) ? esc($jobs["THH03"]["description"]) : "Description not available."; ?>
                        </p>
